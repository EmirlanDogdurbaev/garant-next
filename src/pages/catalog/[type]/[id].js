...
const ProductDetailPage = ({ initialData, initialLanguage }) => {
  ...
  return (
    <>
      <Head>
        <title>{product?.name || "Продукт"} | Iskender Group</title>
        <meta
          name="description"
          content={
            product?.description ||
        ...
        <meta
          ...
          content={
            product?.tags?.join(", ") ||
            "Продукт, Iskender Group, Купить, Товары, Магазин"
          }
        />
        ...
        <meta name="twitter:card" content="iskender_main.svg" />
        ...
        <link
          rel="canonical"
          href={`https://iskender.kg/catalog/product/${id}`}
        />
                ...
                {Array.isArray(product.colors) &&
                  product.colors
                    .filter(
                      (color, index, self) =>
                        index ===
                        self.findIndex((c) => c.hash_color === color.hash_color)
                    )
                    .map((color, index) => (
                      <li
                        key={index}
                        ...
                        className={`color-item ${
                          selectedColor === color.hash_color ? "active" : ""
                        }`}
